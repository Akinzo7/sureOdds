...
export default function BasketballError({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
    console.error("[Basketball ErrorBoundary]", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="mb-2 text-2xl font-bold text-foreground">
        Basketball Dashboard Error
      </h2>
      <p className="mb-6 max-w-md text-sm leading-relaxed text-muted">
        Something went wrong loading the basketball predictions. This could be a
