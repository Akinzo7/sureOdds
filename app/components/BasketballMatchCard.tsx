...
export default function BasketballMatchCard({
  match,
  isSelected,
  onToggle,
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 mb-4">
          <div className="flex-1 rounded-lg bg-background border border-border-subtle py-1.5 flex flex-col items-center">
            <span className="text-[10px] uppercase tracking-wider font-semibold text-muted">Spread</span>
            <span className="text-sm font-bold text-foreground">
              {match.pointSpread > 0 ? `+${match.pointSpread}` : match.pointSpread === 0 ? "PK" : match.pointSpread}
            </span>
          </div>
          <div className="flex-1 rounded-lg bg-background border border-border-subtle py-1.5 flex flex-col items-center">
            <span className="text-[10px] uppercase tracking-wider font-semibold text-muted">Total Points</span>
            <span className="text-sm font-bold text-foreground">
              {match.totalPoints}
            </span>
          </div>
